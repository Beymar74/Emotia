  ...
  return (
    <>
      <style>{`
        ...
        .hero-bg { background: linear-gradient(135deg, ${P.blanco} 0%, ${P.beige} 100%); position: relative; overflow: hidden; }
        .hero-grad-text { background: linear-gradient(90deg, ${P.granate}, ${P.dorado}, ${P.carmesi}, ${P.granate}); background-size: 250% auto; -webkit-background-clip: text; -webkit-text-fill-color: transparent; background-clip: text; animation: shimmer-e 4s linear infinite; }
        ...
        <div style={{ maxWidth: 1320, margin: "0 auto", padding: "40px 24px 60px", position: "relative", zIndex: 2 }}>
          <div className="hero-grid">
            <div style={{ display: "flex", flexDirection: "column" }}>
              ...
              <motion.div initial={{ opacity: 0, y: 14 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.6, delay: 0.4 }} style={{ display: "flex", alignItems: "center", gap: 16, flexWrap: "wrap" }}>
                {[
