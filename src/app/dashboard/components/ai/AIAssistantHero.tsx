...
export default function AIAssistantHero({ userName }: { userName: string }) {
  ...
  return (
    <section className="text-center mb-16 max-w-3xl mx-auto pt-8">
      ...
      <p className="text-lg text-[#5C3A2E] mb-10 opacity-80">Cuéntame la ocasión o el presupuesto. Yo me encargo del resto.</p>
