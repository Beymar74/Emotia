            ...
            {empresa._count.detalle_pedidos === 0 && empresa._count.productos === 0 ? (
              ...
              <div className="grid grid-cols-2 gap-4">
                <div className="bg-[#FAF3EC] rounded-xl p-4 text-center">
                  <p className="font-serif text-3xl font-bold text-[#8E1B3A]">{empresa._count.productos}</p>
                  <p className="text-sm text-[#7A5260] mt-1">Productos en catálogo</p>
                </div>
                <div className="bg-[#EEF8F0] rounded-xl p-4 text-center">
                  ...
                  <p className="text-sm text-[#7A5260] mt-1">Ítems despachados</p>
                </div>
              </div>
            )}
          </div>
