...
const subPages = [
  { href: "/admin/empresas", label: "Directorio", icon: "≡" },
    ...
    <div className="space-y-6">
      ...
      {rendimientoMapeado.length === 0 ? (
        <div className="bg-white rounded-xl border border-[#8E1B3A]/10 p-12 text-center">
          <p className="text-sm font-medium text-[#5A0F24] mb-1">Sin datos de rendimiento</p>
          <p className="text-xs text-[#7A5260]">No hay empresas activas para mostrar métricas.</p>
        </div>
      ) : (
        <>
