  ...
  return (
    <div className="space-y-6">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3">
        ...
        <select className="self-start sm:self-auto text-sm border border-[#8E1B3A]/15 rounded-lg px-4 py-2.5 outline-none text-[#7A5260] bg-white">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-4 sm:gap-5">
        {rendimientoMapeado.map((r: RendimientoData) => (
          <div key={r.id} className="bg-white rounded-xl border border-[#8E1B3A]/10 p-4 sm:p-5">
            {/* Header card */}
            ...
            <button className="w-full mt-4 text-sm border border-[#8E1B3A]/20 text-[#8E1B3A] py-2 rounded-lg font-medium hover:bg-[#8E1B3A]/5 transition-colors">
      ...
      <div className="bg-white rounded-xl border border-[#8E1B3A]/10 p-3 sm:p-5">
        ...
        <div className="hidden lg:block overflow-x-auto">
          <table className="w-full border-collapse">
            <thead>
              <tr>
                {["Proveedor", "Monto total", "Completados", "Cancelados", "Tasa éxito", "Calificación", "Ranking"].map((h) => (
