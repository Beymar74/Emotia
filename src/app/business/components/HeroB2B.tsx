...
export default function HeroB2B() {
  ...
  return (
    <section
      className="relative isolate overflow-hidden min-h-[100svh] flex items-center font-sans"
      style={{
        backgroundColor: "#FCFAF8",
        // Si tu header es fijo/sticky, esta variable te ayuda a separarlo bien.
    ...
    >
      ...
      <div className="relative z-10 w-full max-w-[1320px] mx-auto px-6 md:px-12 py-12 md:py-16 flex flex-col lg:flex-row items-center gap-12 lg:gap-20">
        {/* Columna izquierda */}
        <div className="flex-1 w-full max-w-xl">
          ...
          >
            Únete a la red premium de regalos más prestigiosa de Bolivia.
            Conecta con clientes que valoran la calidad, gestiona tu taller con
            herramientas ejecutivas y deja la logística en nuestras manos.
          </motion.p>
        ...
        <motion.div
          ...
          className="flex-1 w-full relative hidden lg:block min-h-[520px]"
        >
          <div
          ...
          >
            ...
            <div
              style={{
                position: "absolute",
                inset: 0,
                background: `linear-gradient(to top, ${P.bordoNegro}CC 0%, transparent 40%)`,
              }}
            />
            ...
            <div className="absolute bottom-6 left-6 right-6 text-center">
              <p
                ...
                style={{ fontFamily: "'Montserrat', sans-serif" }}
              >
                "Emotia Business nos dio la tecnología para alcanzar clientes
          ...
          >
            <div className="p-3 rounded-xl" style={{ background: P.beige }}>
              <Package size={22} color={P.bordoOscuro} />
            </div>
            <div>
              <div
              ...
              <div className="text-sm font-bold" style={{ color: P.bordoNegro }}>
                Caja Sorpresa Ejecutiva
              </div>
              <div
          ...
          <div
            ...
            style={{
              ...
              boxShadow: `0 20px 40px rgba(0,0,0,0.1)`,
              border: `1px solid ${P.blanco}`,
              animation: "float-delayed 7s ease-in-out infinite alternate",
            }}
          >
            <div className="p-3 rounded-xl" style={{ background: `${P.beige}80` }}>
              <Star size={24} color={P.doradoOscuro} fill={P.doradoOscuro} />
            </div>
            <div>
              <div className="text-lg font-black" style={{ color: P.bordoNegro }}>
                4.9/5 Rating
              </div>
              <div
